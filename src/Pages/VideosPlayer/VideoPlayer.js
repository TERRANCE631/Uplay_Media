        ...
        <section>
            <div className="flex flex-col justify-center">
                <section className="grid xl:pr-10 md:pl-2 pl-1 pr-2 w-full lg:grid-cols-[2fr_1fr] grid-cols-1 gap-4">
                    <div className="border border-dashed border-black rounded-lg w-full xl:h-[28rem] 2xl:h-[45rem] md:h-[25rem] 
                        h-[16rem]" >
                    ...
                    <div className="w-full shrink-0 h-full truncate">
                        ...
                        2xl:h-[8rem] h-[6rem]">
                            <video autoPlay muted src="/Assets/feature-5.mp4" alt="" className="object-cover object-center 
