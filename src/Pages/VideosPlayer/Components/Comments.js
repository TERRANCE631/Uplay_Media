        ...
        <section className="">
            <div className="flex items-center">
                <input
                    ...
                    id=""
                />
                <button className="py-2.5 border border-blue-700 md:px-8 px-4 shadow-inner shadow-gray-500 
                bg-blue-500 text-2xl rounded-r-full">
                    <BiSolidSend />
                </button>
            </div>
            <p className="mt-2">Comments: ({commentList.length})</p>
            <div className="my-5">
                    ...
                    return (
                        <div key={i} className="">
                            <div className="flex items-baseline bg-gray-300/30 gap-2 mb-2 px-2 py-1">
                                <button className="">
                                    <p className="font-bold">Terrance:</p>
                                </button>
                                <div className="">
